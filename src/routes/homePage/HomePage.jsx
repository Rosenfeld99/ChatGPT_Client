  ...
  return (
    <div className="flex items-center lg:flex-row flex-col gap-5 lg:gap-24 h-full relative">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-4 text-center max-w-[80%] ">
        ...
        <Link to="/dashboard" className="px-6 py-4 bg-[#217bfe] text-white rounded-2xl text-sm mt-5 transition-transform duration-300 ease-in-out hover:bg-white hover:text-[#217bfe] hover:scale-110">
          Get Started
        </Link>
      </div>
